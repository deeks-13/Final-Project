...
file_path = os.path.join(project_root, 'Portfolio/accepted_2007_to_2018Q4.csv')
...
MODEL_INFO = {
    ...
    "keys"      : ['loan_amnt', 'int_rate', 'dti', 'annual_inc'],
    "inputs"    : [
        {"name": "loan_amnt",  "type": "number", "min": 0.0,   "max": 40000.0, "default": 10000.0, "step": 100.0},
        {"name": "int_rate",   "type": "number", "min": 0.0,   "max": 35.0,    "default": 12.0,    "step": 0.1},
        {"name": "dti",        "type": "number", "min": 0.0,   "max": 50.0,    "default": 15.0,    "step": 0.1},
